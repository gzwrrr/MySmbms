...
<div class="right">
    ...
    <div class="providerAdd" id="billAdd-box">
        <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/jsp/bill.do">
            ...
            <div class="bill-common" id="list-7">
                <label >是否付款：</label>
