...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public boolean delete(String commentId) throws SQLException {
        Connection connection = null;
        boolean flag = false;
        try {
            connection = BaseBao.getConnection();
            connection.setAutoCommit(false);
            if (commentDao.delete(connection, commentId))
                flag = true;
            connection.commit();
        } catch (Exception e) {
            connection.rollback();
    ...
    @Override
    public List<Comment> query(String goodId) throws SQLException {
    ...
    public void test() throws SQLException {
        ...
        List<Comment> commentList = commentService.query("1");
